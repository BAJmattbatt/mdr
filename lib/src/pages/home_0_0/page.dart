...
class PageHomeA00 extends StatefulWidget {
  const PageHomeA00({
    Key? key,
  }) : super(key: key);

  @override
  _StateHomeA00 createState() => _StateHomeA00();
}

class _StateHomeA00 extends AuthState<PageHomeA00>
        ...
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              color: Color(0xFF000E2B).withOpacity(1),
              border: Border(
                left: BorderSide(
                    width: 0,
          ...
          Positioned(
              ...
              child: Container(
                ...
                height: 52,
                decoration: BoxDecoration(
                  color: Color(0xFF001440).withOpacity(1),
