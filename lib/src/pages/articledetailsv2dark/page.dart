...
class PageArticleDetailsVA2DARK extends StatefulWidget {
  const PageArticleDetailsVA2DARK({
    Key? key,
    this.articleImage =
  ...
  @override
  _StateArticleDetailsVA2DARK createState() => _StateArticleDetailsVA2DARK();
}

class _StateArticleDetailsVA2DARK extends AuthState<PageArticleDetailsVA2DARK>
